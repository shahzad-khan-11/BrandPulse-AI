...
/**
 * Login OTP verification email — sent during login
 */
export const sendLoginOtpEmail = async (email, name, otpCode) => {
  const content = `
    <h2 style="margin:0 0 16px;font-size:22px;font-weight:700;color:#e2e8f0;">
    ...
    <p style="color:#94a3b8;margin:0 0 16px;">Hello <strong style="color:#e2e8f0;">${name || 'User'}</strong>,</p>
    <p style="color:#94a3b8;margin:0 0 16px;">
      Use the following 6-digit code to complete your login to BrandPulse AI:
    </p>
